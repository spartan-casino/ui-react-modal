      ...
      <div className={classes.root}>
            ...
            <div className={classes.titleBalance}>
              ...
              <div className={classes.buyModal}>
                ...
                <div className={classes.buyModalContent}>
                  <Typography variant={"h3"}>WAR AMOUNT</Typography>
                  <TextField
                    fullWidth
                  ...
                  >
                    ...
                    {"BNB for "}
                    {this.state.amount ? this.state.amount : 0} {"WAR"}
                  </Typography>
                  <div className={classes.buttonContainer}>
                    ...
                    {!isMobile && !address && (
                      <LightTooltip title="please connect your wallet to BUY WAR TOKENS">
                        <span>
                          <Button
                            className={classes.actionButtonDisabled}
                            variant="outlined"
        ...
        <div className={classes.footer}>
          <Typography variant={"h4"}>
            Copyright &copy; 2021 Spartan.casino. All rights reserved.
          </Typography>
        </div>
